  ...
  const milestones: Milestone[] = [
    {
      ...
      icon: <GraduationCap className="h-5 w-5 text-lunar-gold" />
    },
    {
      id: 2,
      ...
      icon: <Award className="h-5 w-5 text-lunar-gold" />
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: <Cpu className="h-5 w-5 text-lunar-gold" />
    }
  ];
  ...
  return (
    <div className="flex flex-col gap-12 py-6 md:py-12">
      ...
      <div className="border-b border-white/5 pb-8">
        <span className="font-mono text-xs uppercase tracking-widest text-lunar-gold">Timeline</span>
      ...
      <div className="relative max-w-4xl mx-auto py-8 pl-8 md:pl-0 md:flex md:flex-col md:items-center">
        ...
        <div className="absolute top-0 bottom-0 left-3 md:left-1/2 w-0.5 bg-gradient-to-b from-lunar-gold/30 via-lunar-gold/10 to-transparent transform -translate-x-1/2" />
        ...
        >
          {milestones.map((milestone, idx) => {
            ...
            return (
              ...
              >
                {/* Timeline Node Point */}
                <div className="absolute left-[-29px] md:left-1/2 top-4 w-5 h-5 rounded-full border-2 border-lunar-gold bg-[#05070C] z-10 transform -translate-x-1/2 flex items-center justify-center transition-all duration-300 hover:scale-125 hover:shadow-[0_0_15px_#FFD700]">
                  <div className="w-1.5 h-1.5 rounded-full bg-lunar-gold animate-ping" />
                </div>
                ...
                {/* Content Card */}
                <div className="w-full md:w-[45%] bento-card p-6 hover:border-lunar-gold/30 transition-all duration-300">
                  {/* Period Tag */}
                  <div className="flex items-center gap-1.5 text-lunar-gold font-mono text-xs mb-3">
                  ...
                  {/* Bullet Details */}
                  <ul className="space-y-2 border-t border-white/5 pt-4 mt-2">
                    {milestone.details.map((detail, dIdx) => (
                      <li key={dIdx} className="flex items-start gap-2 text-xs text-slate-400 leading-normal font-sans">
                        <Bookmark className="h-3 w-3 text-lunar-gold/60 mt-0.5 flex-shrink-0" />
                        <span>{detail}</span>
                      </li>
                    ))}
                  </ul>
