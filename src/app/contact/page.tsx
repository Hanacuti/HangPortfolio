        ...
        <div className="bento-card max-w-xl w-full p-8 md:p-10 flex flex-col items-center text-center gap-6">
          ...
          <div>
            ...
            <a
              ...
              className="inline-block text-xl md:text-2xl font-serif font-extrabold text-ceramic-pink mt-2 hover:text-slate-800 transition-colors duration-300 border-b-2 border-dashed border-ceramic-pink/30 hover:border-slate-800/30 pb-1"
            >
              hanacuti0507@gmail.com
            </a>
          </div>

          <p className="text-slate-500 text-xs md:text-sm leading-relaxed max-w-md font-sans">
          ...
          <div className="w-full border-t border-ceramic-pink/10 pt-6 mt-2 text-[10px] text-slate-400 font-mono">
            Mọi phản hồi sẽ được phản hồi trong vòng 24 giờ làm việc.
          </div>
        </div>
      </div>
    </div>
